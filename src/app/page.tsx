...
const FAQ_ITEMS = [
  {
    ...
    description:
      "Irfan Wizards operates without signing any contracts. You subscribe, I start work. You can pause or cancel at any time using the customer portal. Also, Irfan Wizards is just one person (me), so know who will be working on your project. This also means limited availability.",
  },
  {
    title: "Who is this for?",
    description:
      "This offer works particularly well with early stage startups that does not always have the budget and time to hire a full-time developer. With Irfan Wizards, they get an experienced developer without worrying about contacts, time commitment or spending time on finding the right person.",
  },
  {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center p-4 md:p-24">
      <main className="space-y-12 max-w-xl">
        <section className="flex flex-col min-h-0 gap-y-6">
          <div>
            ...
            <div className="text-xs font-mono text-pretty">
              /ɪrˈfɑːn ˈwɪzədz/ - A program designed to automate difficult tasks by asking a series of 
              straightforward questions to the user. And different from or in a position away from others in the group
            </div>
          </div>

          <p className="text-base text-wrap">
            <a href="https://irfanwizards.tech/" target="_blank" className="underline">
              I&apos;m Irfan, an experienced Full-Stack Developer who builds tech products.
            </a>{" "}
            Irfan Wizards is a tiny development studio where I focus on helping
            startups build and improve their products based on Next.js, Nuxt.js, Node.js, Django, Flask framework.
          </p>
        ...
        <MagicContainer className="flex flex-col md:flex-row gap-6 md:-m-6 items-stretch">
          <MagicCard className="flex-1">
            <CardHeader>
              ...
              <CardDescription className="max-w-md">
                Suitable for existing application. Requires granting
          ...
          <MagicCard className="flex-1">
            <CardHeader>
              ...
              <CardDescription className="max-w-md">
                Creating a new application from scratch including
        ...
        {/* Commenting the "Companies I worked with" section */}
        {/* 
